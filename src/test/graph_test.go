...
func TestNewGraphFromAdjacencyMatrix(t *testing.T) {
	...
	adjacencyMatrix.Matrix[0][1] = 1.0
	adjacencyMatrix.Matrix[0][2] = 2.0
	adjacencyMatrix.Matrix[0][3] = 0

	adjacencyMatrix.Matrix[1][0] = 1.0
	adjacencyMatrix.Matrix[1][1] = 0
	adjacencyMatrix.Matrix[1][2] = 3.0
	adjacencyMatrix.Matrix[1][3] = 0

	adjacencyMatrix.Matrix[2][0] = 2.0
	adjacencyMatrix.Matrix[2][1] = 3.0
	adjacencyMatrix.Matrix[2][2] = 0
	adjacencyMatrix.Matrix[2][3] = 4.0

	adjacencyMatrix.Matrix[3][0] = 0
	adjacencyMatrix.Matrix[3][1] = 0
	adjacencyMatrix.Matrix[3][2] = 4.0
	...
	expectedEdges := map[int]map[int]float64{
		0: {1: 1.0, 2: 2.0},
		1: {0: 1.0, 2: 3.0},
		2: {0: 2.0, 1: 3.0, 3: 4.0},
		3: {2: 4.0},
